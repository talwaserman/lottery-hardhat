...
export interface VRFProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addToAllowList"
...
export interface VRFProvider extends BaseContract {
  connect(runner?: ContractRunner | null): VRFProvider;
  waitForDeployment(): Promise<this>;

  interface: VRFProviderInterface;
