...
export interface VRFV2ProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addToAllowList"
...
export interface VRFV2Provider extends BaseContract {
  connect(runner?: ContractRunner | null): VRFV2Provider;
  waitForDeployment(): Promise<this>;

  interface: VRFV2ProviderInterface;
