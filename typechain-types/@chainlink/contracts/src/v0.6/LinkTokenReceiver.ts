...
export interface LinkTokenReceiverInterface extends Interface {
  getFunction(
    nameOrSignature: "getChainlinkToken" | "onTokenTransfer"
  ): FunctionFragment;
...
export interface LinkTokenReceiver extends BaseContract {
  connect(runner?: ContractRunner | null): LinkTokenReceiver;
